...
@section('title','MHAJE || PÁGINA DE PRODUCTOS')
...
<div class="col-lg-9 col-md-8 col-12">
    <div class="row">
        <div class="col-12">
            ...
            <!--/ End Barra Superior de la Tienda -->
        </div>
    </div>
    <div class="row">
        @if(count($products))
            @foreach($products as $product)
                {{-- {{$product}} --}}
										...
										<!-- Inicio de un solo elemento de la lista -->
<div class="col-12">
    <div class="row">
...
<!-- Fin de un solo elemento de la lista -->
@endforeach
@else
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="quickview-content">
                            ...
                            <!-- Compartir esto BEGIN --><div class="sharethis-inline-share-buttons"></div><!-- Compartir esto END -->
                            </div>
                        </div>
                    </div>
                </div>
