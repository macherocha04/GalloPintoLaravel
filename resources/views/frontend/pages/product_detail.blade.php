...
@section('title', 'MHAJE || DETALLE DEL PRODUCTO')
                            ...
                            <div class="product-des">
                                ...
                                <div class="short">
                                    ...
                                    <div class="rating-main">
                                        ...
                                        <a href="#" class="total-review">({{$product_detail['getReview']->count()}}) Reseñas</a>
                                    </div>
                                    @php 
                                        $after_discount = ($product_detail->price - (($product_detail->price * $product_detail->discount) / 100));
                                    @endphp
                                    <p class="price"><span class="discount">C$ {{number_format($after_discount, 2)}}</span><s>C$ {{number_format($product_detail->price, 2)}}</s> </p>
...
<div class="product-buy">
    ...
    @endif
    <p class="disponibilidad">Stock : @if($product_detail->stock>0)<span class="badge badge-success">{{$product_detail->stock}}</span>@else <span class="badge badge-danger">{{$product_detail->stock}}</span>  @endif</p>
</div>
<!--/ End Compra del producto -->
        ...
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="rating_box">
                                <div class="star-rating">
                                    <div class="star-rating__wrap">
                                        ...
                                        <input class="star-rating__input" id="star-rating-4" type
                                        ...
                ...
                <p class="text-center p-5">
                    Necesitas <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">iniciar sesión</a> O <a style="color:blue" href="{{route('register.form')}}">registrarte</a>
                </p>
                <!--/ Fin del Formulario -->
...
<div class="ratting-main">
    ...
    <!--/ Fin de Calificación Individual -->
    @endforeach
</div>
